package com.example.packmybag.Constants;
...
public class MyConstants {
    ...
    public static final String PERSONAL_CAMEL_CASE = "Personal";
    ...
    public static final String MY_SELECTION_CAMEL_CASE = "My Selection";
